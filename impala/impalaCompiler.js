...
function ImportDecl(){var $path=createParserContext()._,_sv$path;return (function(){var _b=_i;return IMPORT()&&_()&&((_sv$path=_val,_val=$path,(StringLiteral()))&&($path=_val,_val=_sv$path,true)||(_val=_sv$path,false))&&_()||(_im=(_i>_im?_i:_im),_i=_b,false)})()};
