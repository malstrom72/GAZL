	...
	: undefined;
{
    ...
    var initTargetType = undefined;                      /// declared element TYPE an `InitList`'s entries answer to, whole ('p'/'F'/...)
    var initTargetElem = undefined;                      /// ...and its element chain - the pair initElemType drops, because makeConstant cannot take it
    var switchStack = [];
    var noForward = false;
