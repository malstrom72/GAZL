	...
	: undefined;
{
    ...
    structAllocSize = function (structName, words) {
        return isExternStruct(structName) ? ('*.z.' + structName) : ('*' + words);
    };
