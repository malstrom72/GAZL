...
function KEYWORD($){return (function(){var _b=_i;return ABS($)||(_im=(_i>_im?_i:_im),_i=_b,false)||ARRAY($)||(_im=(_i>_im?_i:_im),_i=_b,false)||ASSERT($)||(_im=(_i>_im?_i:_im),_i=_b,false)||CASE($)||(_im=(_i>_im?_i:_im),_i=_b,false)||CONST($)||(_im=(_i>_im?_i:_im),_i=_b,false)||COPY($)||(_im=(_i>_im?_i:_im),_i=_b,false)||DEFAULT($)||(_im=(_i>_im?_i:_im),_i=_b,false)||DO($)||(_im=(_i>_im?_i:_im),_i=_b,false)||ELSE($)||(_im=(_i>_im?_i:_im),_i=_b,false)||EXPORT($)||(_im=(_i>_im?_i:_im),_i=_b,false)||EXTERN($)||(_im=(_i>_im?_i:_im),_i=_b,false)||FLOAT($)||(_im=(_i>_im?_i:_im),_i=_b,false)||FLOOR($)||(_im=(_i>_im?_i:_im),_i=_b,false)||FOR($)||(_im=(_i>_im?_i:_im),_i=_b,false)||FROM($)||(_im=(_i>_im?_i:_im),_i=_b,false)||FTOI($)||(_im=(_i>_im?_i:_im),_i=_b,false)||FUNCPTR($)||(_im=(_i>_im?_i:_im),_i=_b,false)||FUNCTYPE($)||(_im=(_i>_im?_i:_im),_i=_b,false)||FUNCTION($)||(_im=(_i>_im?_i:_im),_i=_b,false)||GLOBAL($)||(_im=(_i>_im?_i:_im),_i=_b,false)||GOTO($)||(_im=(_i>_im?_i:_im),_i=_b,false)||IF($)||(_im=(_i>_im?_i:_im),_i=_b,false)||IMPORT($)||(_im=(_i>_im?_i:_im),_i=_b,false)||INT($)||(_im=(_i>_im?_i:_im),_i=_b,false)||ITOF($)||(_im=(_i>_im?_i:_im),_i=_b,false)||LOCALS($)||(_im=(_i>_im?_i:_im),_i=_b,false)||LOOP($)||(_im=(_i>_im?_i:_im),_i=_b,false)||NATIVE($)||(_im=(_i>_im?_i:_im),_i=_b,false)||NULL($)||(_im=(_i>_im?_i:_im),_i=_b,false)||NULLFUNC($)||(_im=(_i>_im?_i:_im),_i=_b,false)||POINTER($)||(_im=(_i>_im?_i:_im),_i=_b,false)||READONLY($)||(_im=(_i>_im?_i:_im),_i=_b,false)||RETURNS($)||(_im=(_i>_im?_i:_im),_i=_b,false)||SIZEOF($)||(_im=(_i>_im?_i:_im),_i=_b,false)||STRUCT($)||(_im=(_i>_im?_i:_im),_i=_b,false)||SWITCH($)||(_im=(_i>_im?_i:_im),_i=_b,false)||TEMPORARY($)||(_im=(_i>_im?_i:_im),_i=_b,false)||TO($)||(_im=(_i>_im?_i:_im),_i=_b,false)||WHILE($)||(_im=(_i>_im?_i:_im),_i=_b,false)})()};
