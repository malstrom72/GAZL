...
For what each file in `impala/` is, and the two golden-fixture systems, see [`README.md`](../../docs/README.md).
For JSPEG internals, self-hosting, and regeneration, see `JSPEG.md`. This document covers the CLI and
the programmatic API in detail.
