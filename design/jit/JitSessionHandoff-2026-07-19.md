...
- **v2.3b within-realm precision is DEAD as a JIT tier** (Magnus). Vortex debunked as its motivating case
  ...
  `&a[lo:hi]`, index-less sliced deref ops - full design record in `design/jit/SliceBoundsDesign.md` (committed).
...
Investigation DONE - read `design/impala/InliningInvestigation.md` first (committed). Highlights:
