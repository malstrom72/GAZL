...
compiled without Node.js or PikaCmd.
...
```bash
cd output
./NuXJS -s impala.nuxjs.js ../tests/impala/sources/calc.impala 0x4d2 calc.impala > calc.gazl
./NuXJS -s impala.nuxjs.js ../tests/impala/sources/multitap_code.impala 0x4d2 multitap_code.impala > multitap.gazl
...
```bash
cd output
./NuXJS -s impala.nuxjs.js ../impala/ImpalaDemo.impala 0x4d2 ImpalaDemo.impala > demo.gazl
```
...
```bash
./output/NuXJS -s output/impala.nuxjs.js impala/ImpalaDemo.impala 0x4d2 impala/ImpalaDemo.impala > output/demo.gazl
